# --- PÁGINA 3: GERENCIAR TUDO ---
    ...
    if not df.empty:
        # 🔧 CORREÇÃO: Remove linhas completamente vazias
        df = df[df['Cliente'].str.strip() != ''].copy()
        
        # 🔧 CORREÇÃO: Garante valores padrão para Data e Hora (evita None)
        ...
        df_editado = st.data_editor(
            ...
            column_config={
                ...
                "Hora": st.column_config.TimeColumn("Hora", format="HH:mm", required=True),
